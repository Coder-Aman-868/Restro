        ...
        <div class="max-w-[1180px] mx-auto w-full flex justify-between items-center">
            ...
            <div class="flex lg:justify-between justify-end items-center gap-10 max-w-[681px] w-full">
                <ul :class="[
                    ...
                    'max-lg:flex-col max-lg:items-center max-lg:h-screen max-lg:w-full max-lg:bg-white',
                ...
                <div class="sm:flex hidden justify-center items-center gap-5">
                    ...
                    <button
                        class="bg-light-pink text-white border-transparent text-base font-medium leading-100 px-5 py-3 rounded-lg hover:bg-white border hover:border-light-pink hover:text-light-pink transition-all duration-300 ease-in-out cursor-pointer">Sign
                        Up</button>
                </div>
                <div id="hamburgerToggle" class="hamburger cursor-pointer block lg:hidden" :class="{ active }"
                    @click="toggle">
                    <svg viewBox="0 0 32 32" class="sm:h-16 h-10 transition-transform duration-600 ease-in-out relative z-[999]"
